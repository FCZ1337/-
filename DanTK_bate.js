...
Cheat.PrintColor([132, 112, 255, 255], "•> DanTK.JS | Ver" + version + " <•\n");
Cheat.PrintColor([51, 255, 204, 255], "[DanTK] 感谢使用DanTK.JS,尊敬的用户" + username + "您好! \n");
Cheat.PrintColor([255, 255, 255, 255], "\n");
Cheat.PrintColor([255, 85, 55, 255], "Info: \n");
Cheat.PrintColor([255, 85, 55, 255], "挨打中成长....\n");
Cheat.PrintColor([132, 112, 255, 255], "•> JS by FCZ | Q2261260884 <•\n");
Cheat.PrintColor([255, 255, 255, 255], "===========================================\n");

//SubTab
UI.AddSubTab(["Config", "SUBTAB_MGR"], "[ DanTK ] Rage");
UI.AddSubTab(["Config", "SUBTAB_MGR"], "[ DanTK ] AntiAim");
UI.AddSubTab(["Config", "SUBTAB_MGR"], "[ DanTK ] Visuals");
UI.AddSubTab(["Config", "SUBTAB_MGR"], "[ DanTK ] Misc");
UI.AddSubTab(["Config", "SUBTAB_MGR"], "[ DanTK ] Color");
//Path
const ragePath = ["Config", "[ DanTK ] Rage", "[ DanTK ] Rage"];
const antiaimPath = ["Config", "[ DanTK ] AntiAim", "[ DanTK ] AntiAim"];
const visualsPath = ["Config", "[ DanTK ] Visuals", "[ DanTK ] Visuals"];
const miscPath = ["Config", "[ DanTK ] Misc", "[ DanTK ] Misc"];
const colorPath = ["Config", "[ DanTK ] Color", "[ DanTK ] Color"];
// Constant
...
UI.SetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Background"], [255, 250, 250, 255]); //设置默认颜色
UI.AddColorPicker(colorPath, "Secondary Background");
UI.SetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Secondary Background"], [220, 220, 220, 255]); //设置默认颜色
UI.AddColorPicker(colorPath, "Normal Font");
UI.SetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Normal Font"], [0, 0, 0, 255]); //设置默认颜色
UI.AddColorPicker(colorPath, "Variable Font");
UI.SetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Variable Font"], [65, 105, 225, 255]); //设置默认颜色
UI.AddColorPicker(colorPath, "Separate Font");
UI.SetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Separate Font"], [180, 180, 180, 180]); //设置默认颜色
UI.AddColorPicker(colorPath, "Ico Font");
UI.SetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Ico Font"], [0, 0, 0, 255]); //设置默认颜色
UI.AddCheckbox(colorPath, "==============================");
UI.AddColorPicker(colorPath, "BetterEsp - Point"); //点的颜色
UI.SetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "BetterEsp - Point"], [255, 255, 255, 255]); //设置默认颜色
UI.AddColorPicker(colorPath, "BetterEsp - Name"); //名称颜色
UI.SetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "BetterEsp - Name"], [211, 211, 211, 255]); //设置默认颜色
UI.AddColorPicker(colorPath, "BetterEsp - Weapon"); //武器颜色
UI.SetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "BetterEsp - Weapon"], [211, 211, 211, 255]); //设置默认颜色
UI.AddCheckbox(colorPath, "==============================");
UI.AddColorPicker(colorPath, "LocalTracer - Color");
UI.AddCheckbox(colorPath, "==============================");
UI.SetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "LocalTracer - Color"], [255, 255, 255, 255]); //设置默认颜色
UI.AddColorPicker(colorPath, "Indicators - AA Color");
UI.SetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Indicators - AA Color"], [255, 255, 255, 255]); //设置默认颜色
UI.AddColorPicker(colorPath, "Indicators - DMG Color");
UI.SetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Indicators - DMG Color"], [255, 255, 255, 255]); //设置默认颜色
UI.AddColorPicker(colorPath, "Indicators - DMG UI Color");
UI.SetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Indicators - DMG UI Color"], [255, 255, 255, 255]); //设置默认颜色
UI.AddColorPicker(colorPath, "Indicators - DT Color");
UI.SetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Indicators - DT Color"], [255, 255, 255, 255]); //设置默认颜色
UI.AddColorPicker(colorPath, "Indicators - HS Color");
UI.SetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Indicators - HS Color"], [255, 255, 255, 255]); //设置默认颜色
function ColorMain() {
    bC = UI.GetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Background"]);
    sbC = UI.GetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Secondary Background"]);
    nF = UI.GetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Normal Font"]);
    vF = UI.GetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Variable Font"]);
    iF = UI.GetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Ico Font"]);
    sF = UI.GetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Separate Font"]);
    IndicatorsAA = UI.GetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Indicators - AA Color"]);
    IndicatorsDMG = UI.GetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Indicators - DMG Color"]);
    IndicatorsDMGUI = UI.GetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Indicators - DMG UI Color"]);
    IndicatorsDT = UI.GetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Indicators - DT Color"]);
    IndicatorsHS = UI.GetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "Indicators - HS Color"]);
    BulletTracerColor = UI.GetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "LocalTracer - Color"]);
    BetterEspPoint = UI.GetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "BetterEsp - Point"]);
    BetterEspName = UI.GetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "BetterEsp - Name"]);
    BetterEspWeapon = UI.GetColor(["Config", "[ DanTK ] Color", "[ DanTK ] Color", "BetterEsp - Weapon"]);
}
...
const WaterMark_Path = (["Config", "[ DanTK ] Misc", "[ DanTK ] Misc", "WaterMark"]);
UI.AddCheckbox(miscPath, "Health & Armor"); //血甲条
const HealthArmor_Path = (["Config", "[ DanTK ] Misc", "[ DanTK ] Misc", "Health & Armor"]);

UI.AddCheckbox(miscPath, "BuyList"); //购物清单
const BuyList_Path = (["Config", "[ DanTK ] Misc", "[ DanTK ] Misc", "BuyList"]);
UI.AddMultiDropdown(miscPath, "BuyList Optional", ["Log", "Gui"]); //购物清单可选
const BuyList_MD_Path = (["Config", "[ DanTK ] Misc", "[ DanTK ] Misc", "BuyList Optional"]);
UI.AddSliderInt(miscPath, "BuyList GUI X", 10, Global.GetScreenSize()[0]);
const BuyList_X_Path = (["Config", "[ DanTK ] Misc", "[ DanTK ] Misc", "BuyList GUI X"]);
UI.AddSliderInt(miscPath, "BuyList GUI Y", 10, Global.GetScreenSize()[1]);
const BuyList_Y_Path = (["Config", "[ DanTK ] Misc", "[ DanTK ] Misc", "BuyList GUI Y"]);
UI.AddCheckbox(miscPath, "LocalTracer"); //Local Tracer本地子弹射线
const LocalTracer_Path = (["Config", "[ DanTK ] Misc", "[ DanTK ] Misc", "LocalTracer"]);
UI.AddCheckbox(["Rage", "Anti Aim", "Directions"], "Anti-Bruteforce");
UI.AddSliderInt(miscPath, "BulletTracer Thickness", 1, 50)
const LocalTracerThickness_Path = (["Config", "[ DanTK ] Misc", "[ DanTK ] Misc", "BulletTracer Thickness"]);
UI.AddCheckbox(miscPath, "Core Indicators"); //核心指示器
const CoreIndicators_Path = (["Config", "[ DanTK ] Misc", "[ DanTK ] Misc", "Core Indicators"]);
UI.AddMultiDropdown(miscPath, "Core Indicators Optional", ["AntiAim", "Dmage", "Dmage UI", "Double Tap", "Hide Shots"]); //=============中心指示器
const CoreIndicatorsOptional_Path = (["Config", "[ DanTK ] Misc", "[ DanTK ] Misc", "Core Indicators Optional"]);
//BetterEsp
var pls = 0;
var espIcoSize = 14; //声明Better Esp的图标 大小
function BetterEspMain() {
    var ens = Entity.GetEnemies(); //获取敌方实体索引的数组
    var font = Render.GetFont("DanTK-ArturitoSlab.ttf", 12, false); //获取字体
    var wepIco = Render.GetFont("DanTK-Weapons.ttf", espIcoSize, false); //获取图标字体
    var pointIco = Render.GetFont("DanTK-IconFont.ttf", 21, false); //获取图标字体
    //裁缝开始 来源: Acro.JS
    pls += 0.2;
    if (pls > 10) pls = 0;
...
function MiscMain() {
    var IconFont = Render.GetFont("DanTK-IconFont.ttf", 18, false);
    var Font = Render.GetFont("DanTK-JetBrainsMono.ttf", 16, false);
    /*====================
        WaterMark水印
     =====================*/
    if (UI.GetValue(WaterMark_Path)) {
        ...
        Render.String(screenX - 396, 13, 0, "[DanTK]", nF, Font);
    ...
    var haFont = Render.GetFont("DanTK-ArturitoSlab.ttf", 34, false);
    /*============================
        Health & Armor血甲条
     =============================*/
    ...
    if (UI.GetValue(CoreIndicators_Path)) {
        ...
        if (sel & (1 << 0)) { //AA Indicators
            ...
            var x = screenX / 2,
                y = screenY / 2;
            var arrowFont = Render.GetFont("DanTK-Arrows.ttf", 20, false);
            var indcatorFont = Render.GetFont("DanTK-ArturitoSlab.ttf", 16, false);
            if (invert == 1) {
...
const BetterEsp_Path = (["Config", "[ DanTK ] Visuals", "[ DanTK ] Visuals", "BetterESP"]);
UI.AddMultiDropdown(visualsPath, "BetterESP Optional", ["Name", "Health", "Weapon", "Weapon Ico"]);
const BetterEspOptional_Path = (["Config", "[ DanTK ] Visuals", "[ DanTK ] Visuals", "BetterESP Optional"]);
...
const DTPath = (["Config", "[ DanTK ] Rage", "[ DanTK ] Rage", "DT"]);
UI.AddSliderInt(ragePath, "DT Indicator GUI X", 0, screenX);
const DTx_Path = (["Config", "[ DanTK ] Rage", "[ DanTK ] Rage", "DT Indicator GUI X"]);
UI.AddSliderInt(ragePath, "DT Indicator GUI Y", 0, screenY);
const DTy_Path = (["Config", "[ DanTK ] Rage", "[ DanTK ] Rage", "DT Indicator GUI Y"]);
UI.AddSliderInt(ragePath, "Shift Amount", 0, 62)
const DTsa_Path = (["Config", "[ DanTK ] Rage", "[ DanTK ] Rage", "Shift Amount"]);
UI.AddSliderInt(ragePath, "Tolerance", 0, 8)
const DTt_Path = (["Config", "[ DanTK ] Rage", "[ DanTK ] Rage", "Tolerance"]);
UI.AddSliderInt(ragePath, "Max Ticks", 0, 62)
const DTmt_Path = (["Config", "[ DanTK ] Rage", "[ DanTK ] Rage", "Max Ticks"]);
UI.AddCheckbox(ragePath, "Auto Shift")
const DTas_Path = (["Config", "[ DanTK ] Rage", "[ DanTK ] Rage", "Auto Shift"]);
UI.AddCheckbox(ragePath, "Auto Tolerance")
const DTat_Path = (["Config", "[ DanTK ] Rage", "[ DanTK ] Rage", "Auto Tolerance"]);
UI.AddCheckbox(ragePath, "Auto Max Ticks")
const DTamt_Path = (["Config", "[ DanTK ] Rage", "[ DanTK ] Rage", "Auto Max Ticks"]);
...
const UI_wh = {
    ...
    width: 0,
    bar_width: 0,
    txt: " DanTK.JS || TickBase(V) : " + DTtick + " || States : " + states + " ",
    alpha: 0,
    Amin_speed: 4
}
...
function RageMain() {
    ...
    if (UI.GetValue(DTPath)) {
        ...
        const font = Render.GetFont("DanTK-JetBrainsMono.ttf", 10, false)
        const txt_size = Render.TextSize(UI_wh.txt, font)
        var color = bC
        const weapon_font = Render.GetFont("DanTK-Weapons.ttf", 18, false)
        const bullet_icon = Render.GetFont("DanTK-Bullet.ttf", 16, false)
        if (UI.GetValue(["Rage", "Exploits", "Keys", "Double tap"])) {
            ...
            UI_wh.txt = "  DanTK.JS || TickBase(V) : " + DTtick + " || States : " + states + " "
...
UI.AddSubTab(["Rage", "SUBTAB_MGR"], "DanTK AntiAim"); //添加DanTK AntiAim
UI.AddCheckbox(["Rage", "DanTK AntiAim", "DanTK AntiAim"], "Enable DanTK AntiAim");
UI.AddSliderInt(["Rage", "DanTK AntiAim", "DanTK AntiAim"], "-------------------------------------------------", 0, 1);
UI.AddDropdown(["Rage", "DanTK AntiAim", "DanTK AntiAim"], "DanTK AA Mode", ["Stage AA", "Empty"], 0);//AA选择框
//[0]Stage AA|阶段AA
UI.AddSliderInt(["Rage", "DanTK AntiAim", "DanTK AntiAim"], "", 0, 0);
//Stage DanTK UI
UI.AddDropdown(["Rage", "DanTK AntiAim", "DanTK AntiAim"], "Now AA Mode", ["Static", "Sway", "Idea"], 0);//当前AA选择框
UI.AddSliderInt(["Rage", "DanTK AntiAim", "DanTK AntiAim"], "LBY Offset", -180, 180);//LBY Offset
UI.AddSliderInt(["Rage", "DanTK AntiAim", "DanTK AntiAim"], "Real Offset", -180, 180);//Real Offset
UI.AddSliderInt(["Rage", "DanTK AntiAim", "DanTK AntiAim"], "Yaw Offset", -180, 180);//Yaw Offset
UI.AddDropdown(["Rage", "DanTK AntiAim", "DanTK AntiAim"], "Change AA Event", ["Manual Switch", "Enemy Fire", "Local Miss"], 0);//当前AA选择框
UI.AddDropdown(["Rage", "DanTK AntiAim", "DanTK AntiAim"], "After AA Mode", ["Static", "Sway", "Idea"], 0);//之后AA选择框
UI.AddDropdown(["Rage", "DanTK AntiAim", "DanTK AntiAim"], "Reset AA Event", ["Manual Switch", "Stand Time", "Move Time"], 0);//复位AA选择框
var AA_Mode;
UI.AddSliderInt(["Rage", "DanTK AntiAim", "DanTK AntiAim"], "-------------------------------------------------", 0, 1);
UI.AddCheckbox(["Rage", "DanTK AntiAim", "DanTK AntiAim"], "END");
//  *菜单*
function DanTK_AntiAim_Menu() { //该方法回调纳入 DanTK_AA
    //刷新变量
    AA_Mode = UI.GetValue(["Rage", "DanTK AntiAim", "DanTK AntiAim", "DanTK AA Mode"]);//取AA模式 下标
    //判断 Enable DanTK AntiAim
    if (UI.GetValue(["Rage", "DanTK AntiAim", "DanTK AntiAim", "Enable DanTK AntiAim"])) {
        UI.SetValue(["Rage", "DanTK AntiAim", "DanTK AntiAim", "-------------------------------------------------"], 1);
        UI.SetValue(["Rage", "Anti Aim", "Enabled"], 1);
        UI.SetValue(["Rage", "Anti Aim", "Directions", "Yaw offset"], 0);
        DanTK_AntiAim_Changed();//AA模式选择
    } else {
        UI.SetValue(["Rage", "DanTK AntiAim", "DanTK AntiAim", "-------------------------------------------------"], 0);
    }
}
//  *AA更改*
var LBYOffset = 0;
...
function DanTK_AntiAim_Changed() {
    if (AA_Mode == 0) {
        AntiAim.SetOverride(1);
        UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "Now AA Mode"], 1);
        UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "Change AA Event"], 1);
        UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "After AA Mode"], 1);
        UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "Reset AA Event"], 1);
        UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "LBY Offset"], 1);//LBY Offset
        UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "Real Offset"], 1);//Real Offset
        UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "Yaw Offset"], 1);//Yaw Offset
        //定义当前AA
        switch (UI.GetValue(["Rage", "DanTK AntiAim", "DanTK AntiAim", "Now AA Mode"])) {
            case 0://Static
                UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "LBY Offset"], 1);//LBY Offset
                UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "Real Offset"], 1);//Real Offset
                UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "Yaw Offset"], 1);//Yaw Offset
                LBYOffset = UI.GetValue(["Rage", "DanTK AntiAim", "DanTK AntiAim", "LBY Offset"]);
                RealOffset = UI.GetValue(["Rage", "DanTK AntiAim", "DanTK AntiAim", "Real Offset"]);
                YawOffset = UI.GetValue(["Rage", "DanTK AntiAim", "DanTK AntiAim", "Yaw Offset"]);
            ...
            case 1://Sway
                UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "LBY Offset"], 1);//LBY Offset
                UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "Real Offset"], 1);//Real Offset
                UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "Yaw Offset"], 0);//Yaw Offset
                if (getVelocity(Entity.GetLocalPlayer()) < 3) {//站立
                    if (lbyDirection == 1) {
                        if (LBYOffset <= UI.GetValue(["Rage", "DanTK AntiAim", "DanTK AntiAim", "LBY Offset"])) {
                            LBYOffset += 1;
                        } else {
                            lbyDirection = 0;
                        }
        ...
        UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "Now AA Mode"], 0);
        UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "Change AA Event"], 0);
        UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "After AA Mode"], 0);
        UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "Reset AA Event"], 0);
        UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "LBY Offset"], 0);//LBY Offset
        UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "Real Offset"], 0);//Real Offset
        UI.SetEnabled(["Rage", "DanTK AntiAim", "DanTK AntiAim", "Yaw Offset"], 0);//Yaw Offset
    }
}
...
Cheat.RegisterCallback("Draw", "DanTK_AA");//回调
